...
const FOOD_IMGS = [
    ...
    "https://images.unsplash.com/photo-1517248135467-4c7ed9d421bb?auto=format&fit=crop&q=80&w=800",
...
const RETAIL_IMG = "https://images.unsplash.com/photo-1472851294608-062f824d29cc?auto=format&fit=crop&q=80&w=800";
const HEALTH_IMG = "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?auto=format&fit=crop&q=80&w=800";
const PROFESSIONAL_IMG = "https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800";
const EDUCATION_IMG = "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&q=80&w=800";
const TRAVEL_IMG = "https://images.unsplash.com/photo-1488646953014-85cb44e25828?auto=format&fit=crop&q=80&w=800";
const BEAUTY_IMG = "https://images.unsplash.com/photo-1560750588-73207b1ef5b0?auto=format&fit=crop&q=80&w=800";
const HOME_IMG = "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?auto=format&fit=crop&q=80&w=800";

const EVENT_IMGS = [
    "https://images.unsplash.com/photo-1540575467063-178a50e2fd60?auto=format&fit=crop&q=80&w=800",
...
export const CATEGORY_IMAGES: Record<string, string> = {
    [Category.FOOD]: "https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&q=80&w=800",
    [Category.RETAIL]: RETAIL_IMG,
    [Category.HEALTH]: HEALTH_IMG,
    [Category.PROFESSIONAL]: PROFESSIONAL_IMG,
    [Category.EDUCATION]: EDUCATION_IMG,
    [Category.TRAVEL]: TRAVEL_IMG,
    [Category.BEAUTY]: BEAUTY_IMG,
    [Category.HOME]: HOME_IMG,
};
...
export const SEED_BUSINESSES: Business[] = [
    // ── Food & Beverage ──
    {
        ...
        rating: 4.9, reviewCount: 128, imageUrl: FOOD_IMGS[0],
    ...
    },
    {
        ...
        rating: 4.5, reviewCount: 84, imageUrl: FOOD_IMGS[1],
    ...
    },
    {
        ...
        rating: 4.3, reviewCount: 210, imageUrl: FOOD_IMGS[2],
    ...
    },
    {
        ...
        rating: 4.6, reviewCount: 62, imageUrl: FOOD_IMGS[3],
    ...
    },
    {
        ...
        rating: 4.4, reviewCount: 47, imageUrl: FOOD_IMGS[4],
    ...
    },
    {
        ...
        rating: 4.7, reviewCount: 156, imageUrl: FOOD_IMGS[5],
    ...
    },
    {
        ...
        rating: 4.1, reviewCount: 33, imageUrl: FOOD_IMGS[6],
    ...
    },
    {
        ...
        rating: 4.8, reviewCount: 89, imageUrl: FOOD_IMGS[7],
    ...
    // ── Retail & Shopping ──
    {
        ...
        rating: 4.6, reviewCount: 38, imageUrl: "https://images.unsplash.com/photo-1472851294608-062f824d29cc?auto=format&fit=crop&q=80&w=800",
    ...
    },
    {
        ...
        rating: 4.3, reviewCount: 27, imageUrl: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=800",
    ...
    // ── Health & Wellness ──
    {
        ...
        rating: 4.2, reviewCount: 45, imageUrl: HEALTH_IMG,
    ...
    },
    {
        ...
        rating: 4.8, reviewCount: 52, imageUrl: "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?auto=format&fit=crop&q=80&w=800",
    ...
    // ── Professional Services ──
    {
        ...
        rating: 4.7, reviewCount: 19, imageUrl: PROFESSIONAL_IMG,
    ...
    },
    {
        ...
        rating: 4.5, reviewCount: 14, imageUrl: "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&q=80&w=800",
    ...
    // ── Education ──
    {
        ...
        rating: 4.9, reviewCount: 73, imageUrl: EDUCATION_IMG,
    ...
    // ── Travel ──
    {
        ...
        rating: 4.4, reviewCount: 41, imageUrl: TRAVEL_IMG,
    ...
    // ── Beauty ──
    {
        ...
        rating: 4.6, reviewCount: 31, imageUrl: BEAUTY_IMG,
    ...
    // ── Home Services ──
    {
        ...
        rating: 4.3, reviewCount: 22, imageUrl: HOME_IMG,
    ...
    // ── More Food across regions ──
    {
        ...
        rating: 4.4, reviewCount: 68, imageUrl: FOOD_IMGS[8],
    ...
    },
    {
        ...
        rating: 4.5, reviewCount: 39, imageUrl: FOOD_IMGS[9],
    ...
    // ── Pending submissions ──
    {
        ...
        rating: 0, reviewCount: 0, imageUrl: FOOD_IMGS[10],
    ...
    },
    {
        ...
        rating: 0, reviewCount: 0, imageUrl: FOOD_IMGS[11],
...
export const SEED_EVENTS: Event[] = [
    {
        ...
        location: "Wisma Geylang Serai", imageUrl: EVENT_IMGS[0],
    ...
    },
    {
        ...
        location: "Marina Bay Sands Expo & Convention Centre", imageUrl: EVENT_IMGS[1],
    ...
    },
    {
        ...
        location: "One Raffles Place, Level 30", imageUrl: EVENT_IMGS[2],
    ...
    },
    {
        ...
        location: "Community Club @ Tampines", imageUrl: EVENT_IMGS[3],
    ...
    },
    {
        ...
        location: "MUIS Academy, Braddell Rd", imageUrl: EVENT_IMGS[4],
    ...
    },
    {
        ...
        location: "Malay Heritage Centre, Kampong Glam", imageUrl: EVENT_IMGS[5],
...
export const SEED_BLOG_POSTS: BlogPost[] = [
    {
        ...
        category: 'Dining Spotlight', date: 'May 15, 2024', author: 'Sarah Ahmad', image: BLOG_IMGS[0],
    ...
    },
    {
        ...
        category: 'Lifestyle', date: 'May 13, 2024', author: 'Hafiz Ismail', image: BLOG_IMGS[1],
    ...
    },
    {
        ...
        category: 'Business', date: 'May 10, 2024', author: 'Dr. Yusof Ahmad', image: BLOG_IMGS[2],
    ...
    },
    {
        ...
        category: 'Travel', date: 'Apr 28, 2024', author: 'Nurul Huda', image: BLOG_IMGS[3],
    ...
    },
    {
        ...
        category: 'Lifestyle', date: 'Apr 20, 2024', author: 'Aisyah Lim', image: BLOG_IMGS[4],
    ...
    },
    {
        ...
        category: 'Business', date: 'Apr 15, 2024', author: 'Fadzuli Ahmad', image: BLOG_IMGS[5],
